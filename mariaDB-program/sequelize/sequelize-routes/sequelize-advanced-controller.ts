...
export const sequelizeCreateAdvanced = async (req: Request, res: Response) => {    // Creates the owner "Entre", there dog "Blue" and a visit for Blue
  try {
...
export const sequelizeReadAdvanced = async (req: Request, res: Response) => {    // Select all owners who have a hamster that has had a visit
  try {
...
export const sequelizeUpdateAdvanced = async (req: Request, res: Response) => {  // Update the owner "Entre" and the visit for there Blue
  try {
...
export const sequelizeDeleteAdvanced = async (req: Request, res: Response) => {    // Delete the owner "Entre", there dog "Blue" and the visit for Blue
  try {
